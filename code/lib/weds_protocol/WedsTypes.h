...
enum WedsAckStatus : uint8_t {
    ...
    WEDS_ACK_STATUS_INVALID_PACKET = 1, // Packet is malformed or does not conform to protocol specifications.
    WEDS_ACK_STATUS_UNSUPPORTED_MSG = 2, // Message type is not recognized or supported by the receiver.
    WEDS_ACK_STATUS_CRC_ERROR = 3 // CRC check failed.
};